...
databaj <- data.frame(matrix(1:1859),as.double(databaj$volume),databaj$open)
colnames(databaj) <- c("t","Yt","Xt")
databaj
```
...
```{r}
#SPLIT DATA
train<- databaj[1:1486,]
test<- databaj[1487:1859,]
```
