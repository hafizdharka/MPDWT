...
```{r}
library(rio)
stas = import("https://raw.githubusercontent.com/farrasdp/mpdw/main/Pertemuan%201/dataset%20tugas.csv")
stas = stas[,2]
stas = ts(stas)
stas
```
...
Berdasarkan plot ACF, terlihat bahwa plot ACF pada data tersebut cenderung *tails off* dan membentuk gelombang tale off.
...
Gambar di atas menunjukkan nilai *rounded value* ($\lambda$) optimum sebesar **0,96** dan pada selang kepercayaan 95% nilai memiliki batas bawah **0,68** dan batas atas **1,24**. Selang tersebut memuat nilai satu sehingga dapat dikatakan bahwa data bangkitan stasioner dalam ragam.
